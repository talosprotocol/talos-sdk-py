...
BOB_SPK_SIG = b64u_decode("aubPCBHtdqGqq7vBOSFzLl4o5FFfO4jUaTVPtVO3mJ9Q2cYmd9SSQ7kEkwFDADLJqB2Uk66xcciuW1r4rD4lCA")
...
def get_trace_structure():
    return {
        ...
        "bob": {
            ...
            "bundle_secrets": {
                "signed_prekey_private": b64u_encode(BOB_SPK_PRIV)
            }
        },
        "steps": []
    }
...
def main():
    ...
    # Inject fixed SPK
    bob_mgr._signed_prekey = KeyPair(private_key=BOB_SPK_PRIV, public_key=BOB_SPK_PUB, key_type="x25519")
    ...
    # Step 2: Bob receives
    bob_session = bob_mgr.create_session_as_responder("did:alice", b64u_decode(envelope["header"]["dh"]))
